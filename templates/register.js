													...
													<table class="heading_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;text-align:center;">
																<h1 style="margin: 0; color: #8a3c90; font-size: 38px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">E commerce ailesine hoşgeldiniz</span></h1>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;font-size:16px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:28.8px;">
																	<p style="margin: 0;">E commerce ailesine hoşgeldiniz. Bizi tercih ettiğiniz için teşekkürler. Bizimle devam etmek için hesabınızı aktif etmelisiniz. Aşağıdaki linke tıklayarak hesabınızı aktif hale getirebilir ve Türkiye'nin en iyi e ticaret platformuna katılabilirsiniz.</p>
																</div>
															</td>
														</tr>
													</table>
